...
```{r allinone-schoolclose, warning=FALSE, message=FALSE, fig.height= 12, fig.width = 12}
...
```{r all-in-one-emergDec, warning=FALSE, message=FALSE, fig.height= 10, fig.width = 10}
states <- unique(ftime$geo_value)
...
```{r all-in-one bar restriction, warning=FALSE, message=FALSE, fig.height= 12, fig.width = 12}
states <- unique(ftime$geo_value)
...
```{r all-in-one-restaurant, , warning=FALSE, message=FALSE, fig.height= 12, fig.width = 12}
states <- unique(ftime$geo_value)
