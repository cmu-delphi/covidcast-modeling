...
# 
# ca.chome <- covidcast_signal(data_source = "safegraph", 
...
# 
# ca.rest <- covidcast_signal(data_source = "safegraph", 
...
# 
# 
# GEO_VALUE <- fips_codes[fips_codes$state %in% c("TX"),]$fips
# 
# tx.chome <- covidcast_signal(data_source = "safegraph", 
#                              signal ="completely_home_prop",
#                              start_day = STARTDATE, 
#                              end_day = ENDDATE,
#                              geo_type = GEO_TYPE, 
#                              geo_values = GEO_VALUE)
# 
# tx.bar <- covidcast_signal(data_source = "safegraph", 
...
#                              geo_values = GEO_VALUE)
# 
# tx.rest <- covidcast_signal(data_source = "safegraph", 
#                              signal ="restaurants_visit_prop",
#                              start_day = STARTDATE, 
#                              end_day = ENDDATE,
#                              geo_type = GEO_TYPE, 
...
library(GGally)
ggpairs(all_of_demographics[,c(8,11,12,13,14,15,16,17)], aes(colour = stand, alpha = 0.4))
```
