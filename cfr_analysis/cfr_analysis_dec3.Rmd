...
is maximized at **21 days and also has very little curvature around its **
**maximum.  These values are longer than the analysis done with with an as of**
**of November 16th (which were 16 and 16, respectively).**  From this picture, 
...
somewhere above 1.5% (the horizontal dashed line). **For all lag lengths, it **
**looks like the CFR is possibly dropping in early November; but it really **
**remains to be seen if this is a trend lasting longer than a month, **
**especially for longer lags.**
...
lag drifts up to somewhere close to **20-22**, contributing more evidence that 
