...
as_of = "2020-12-09" # Fetch data "as of" the day we first did this analysis!
...
plot_pred(cfr_pred, geo_value = "us", dt = 16, type = "cfr-global: 1.7", 
  ...
  geom_vline(xintercept=as.Date(as_of)-2, color = "black", linetype="dashed") +
  geom_vline(xintercept=as.Date(original_as_of)-2, color = "black",
             linetype="dashed")
