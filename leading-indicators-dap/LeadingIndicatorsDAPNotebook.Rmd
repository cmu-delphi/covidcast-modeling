...
In this DAP analysis, we report a novel methodology for identifying substantial increases in cases and indicators and quantifying indicator success in anticipating case rises. Our methodology is simple and interpretable and provides several examples across various time periods, where indicator signals (e.g., doctors visits) can anticipate a case rise. Together, our results suggest that doctors visits and the quidel antigen signals perform best in anticipating a case rises and that  generally indicators most frequently lead case rises by over a week.
