...
```{r}
source("LeadingIndicatorTools_V3.R")
library(covidcast)
library(magrittr)
library(tidyverse)
library(assertthat)
...
prepared = get_and_prepare_signals("2020-09-01", "2020-11-30", "doctor-visits", "smoothed_adj_cli", 2000, 80)
...
plot_signals(final_cases_indicator_list, "12031", smooth_and_show_increase_point=TRUE, "Dr visits")
