...
An immediate next step is to fit the model using "data as of", in order to 
understand the degree to which we obtain different performance when
sensorizing with contemporaneous vs latest available data.
...
TODO: scatterplot of slopes as a function of time
