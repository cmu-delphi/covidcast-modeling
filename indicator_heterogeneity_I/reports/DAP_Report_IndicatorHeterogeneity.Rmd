...
knitr::kable(table_df %>% select(-`Ind // Target`),
...
of the spread.  Since the difference in the pointwise medians is apparent,
we do not provide the full tableof resuls.
