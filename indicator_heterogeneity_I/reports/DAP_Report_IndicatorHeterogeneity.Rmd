...
The results are mixed, and I'm not sure how to interpret them.  Before
October 15th, the models which used static sensorized features almost always
performed the best.  After October 15th, sometimes dynamic sensorization
provides the most benefit, sometimes static sensorization.  Disappointingly,
dynamic sensorization always fares worse for Doctor Visits, the indicator
that stands to benefit the most from sensorization.
