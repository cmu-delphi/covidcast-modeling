...
The story becomes more information when we
extend the above analysis to multiple leads, to a range of 5 to 20 days
ahead.  (We also split the data into two time ranges over which
we compute the medians, owing to
