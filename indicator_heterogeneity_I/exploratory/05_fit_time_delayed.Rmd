...
d0[[1]][[2]] %>% arrange(time_value) %>% head
d1[[1]][[2]] %>% arrange(time_value) %>% head
d2[[1]][[2]] %>% arrange(time_value) %>% head

d0[[1]][[2]] %>% arrange(time_value) %>% tail
d1[[1]][[2]] %>% arrange(time_value) %>% tail
d2[[1]][[2]] %>% arrange(time_value) %>% tail

d0[[1]][[2]] %>% filter(lag >= n0) %>% tail
d1[[1]][[2]] %>% filter(lag >= n1) %>% tail
d2[[1]][[2]] %>% filter(lag >= n2) %>% tail

d0[[1]][[2]] %>% pull(lag) %>% unique
d1[[1]][[2]] %>% pull(lag) %>% unique
d2[[1]][[2]] %>% pull(lag) %>% unique

d0[[1]][[2]] %>% nrow
d1[[1]][[2]] %>% nrow
d2[[1]][[2]] %>% nrow

d0[[1]][[2]] %>% filter(lag >= n0) %>% nrow
d1[[1]][[2]] %>% filter(lag >= n1) %>% nrow
d2[[1]][[2]] %>% filter(lag >= n2) %>% nrow
