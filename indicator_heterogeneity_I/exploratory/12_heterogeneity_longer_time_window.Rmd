...
```{r data_ingestion_county, echo = TRUE, cache=FALSE}
...
if (geo_level == 'county') {
  ...
  geo_values = unique(df_signals$geo_value)
}
```
...
```{r plot_slopes, echo = TRUE, cache=FALSE}
QUANTS = c(0.01, 0.99)
...
```{r plot_intercepts, echo = TRUE, cache=FALSE}
QUANTS = c(0.01, 0.99)
